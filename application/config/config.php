...
|
*/
$config['base_url'] = 'localhost/ocr/';
$allowed_domains = array('localhost:8880');
$default_domain  = 'localhost:8880';
$_domain = "";
$_domain_folder = "ocr/";
...
{
        $config['base_url'] = 'https://'.$_domain."/".$_domain_folder;
}
else
{
        $config['base_url'] = 'http://'.$_domain."/".$_domain_folder;
}
...
$config['proxy_ips'] = '';
//redis configaration
$config['cache_path'] = ''; // Set an empty string to use Redis for caching
$config['redis_default']['host'] = '192.168.0.244'; // Redis server host
$config['redis_default']['port'] = '6379'; // Redis server port
$config['redis_default']['password'] = ''; // Redis server password (if any)
$config['redis_default']['database'] = 0; // Redis database number to use
$config['redis_default']['timeout'] = 0; // Timeout in seconds (0 means no timeout)
